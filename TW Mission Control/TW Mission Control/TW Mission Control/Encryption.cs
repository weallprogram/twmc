...
namespace TW_Mission_Control
{
    public class Encryption
    {
        ...
        // http://stackoverflow.com/questions/12592036/taking-a-c-sharp-sha512-hash-and-compare-it-in-php
        public string CreatePasswordHash(string _password, string _salt)
        {
        ...
        /// </remarks>
        public string SimpleEncryptWithPassword(string secretMesage, string password, byte[] nonSecretPayload = null)
        {
            nonSecretPayload = nonSecretPayload ?? new byte[] { };
